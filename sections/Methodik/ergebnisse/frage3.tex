...
Als wohl wichtigste technische Anforderung stellte sich das Monitoring heraus. So beschrieben alle drei Experten die Notwendigkeit ein Monitoring zu implementieren, welches die Kommunikation zwischen den Services überwacht (siehe \combref{appendix:t-32} und \combref{appendix:s-16}). Besonders Herr Rahles verwies auf diese Bedingung.\footnote{
