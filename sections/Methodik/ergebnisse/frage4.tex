...
Christoph Rahles antwortete auf diese Frage: \textit{\enquote{Da gibt es, glaube ich kein Richtig oder Falsch.}} und verdeutlichte, dass die Frage immer im Kontext der wirtschaftlichen und technologischen Situation des Start-up beantwortet werden muss (siehe \combref{appendix:r-6}).
...
Sebastian Schlaak antwortete, dass er mit einem Monolithen anfangen würde, da man mit diesem deutlich schneller entwickeln kann und führte weiter fort, dass die Vorteile von Microservices \textit{\enquote{erst in der späteren Skalierungsphase […] so richtig zum Tragen kommen}} (siehe \combref{appendix:s-21}).
